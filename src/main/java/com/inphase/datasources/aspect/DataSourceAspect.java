package com.inphase.datasources.aspect;

import com.inphase.annotation.DataSource;
import com.inphase.datasources.DataSourceNames;
import com.inphase.datasources.DynamicDataSource;
...
//    @Pointcut("execution(* com.wisesoft.*.service.impl.*.*(..)) || execution(* com.baomidou.mybatisplus.extension.service.impl.*.*(..))" )
    @Pointcut("execution(* com.inphase.*.service.impl.*.*(..)) && @target(com.inphase.annotation.DataSource)")
